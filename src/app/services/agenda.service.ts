...
export class AgendaService {
  ...
  public abrirModal: BehaviorSubject<any> = new BehaviorSubject(false);
  ...
  getContatosFilter(nome: string, idade: number = 0, sexo: string, telefone: string): Observable<ContatosResponse> {
  ...
  postContatos(body: Object): Observable<any>{
    return this.http.post<any>(environment.urlApi, body);
  }
  
  editarContatos(id : number, body: object): Observable<object>{
